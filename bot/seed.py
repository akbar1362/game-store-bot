...
GAMES = [
    ...
    # ===== PlayStation Exclusive Games =====
    {
        ...
        "description": "ماجراجویی عالی الوی در دنیایی پساآخرالزمانی با موجودات مکانیکی",
        "category": "action",
        "platforms": "PS5, PS4",
        "version": "standard",
        "price": 2800000,
    ...
    {
        "name": "Demon's Souls",
        "description": "بازسازی بازی کلاسیک سولز با گرافیک خیره‌کننده نسل نهم",
        "category": "action",
        "platforms": "PS5",
        "version": "standard",
        "price": 3000000,
    ...
    },
    {
        ...
        "description": "ماجراجویی فضایی با گرافیک نسل نهمی خیره‌کننده",
        "category": "action",
        "platforms": "PS5",
        "version": "standard",
        "price": 2500000,
    ...
    {
        "name": "Returnal",
        "description": "شوتر سای‌فای ترسناک با گیم‌پلی روگ‌لایک",
        "category": "shooter",
        "platforms": "PS5, PC",
        "version": "standard",
        "price": 2800000,
    ...
    },
    {
        ...
        "description": "ماجراجویی سامورایی در جزیره تسوشیما",
        "category": "action",
        "platforms": "PS5, PS4",
        "version": "director's_cut",
        "price": 2600000,
        "discount_price": 2000000,
        "discount_percent": 23,
        "stock_status": "in_stock",
    ...
    },
    {
        ...
        "description": "مجموعه ماجراجویی‌های نیتن دریک و کلویی فریزر",
        "category": "adventure",
        "platforms": "PS5, PC",
        "version": "standard",
        "price": 2200000,
    ...
    },
    {
        ...
        "description": "نقش‌آفرینی حماسی با داستانی جذاب و مبارزات هیجانی",
        "category": "action",
        "platforms": "PS5, PC",
        "version": "standard",
        "price": 3200000,
    ...
    },
    {
        ...
        "description": "ادامه بازسازی فاینال فانتزی ۷ با گرافیک فوق‌العاده",
        "category": "rpg",
        "platforms": "PS5",
        "version": "standard",
        "price": 3500000,
    ...
    {
        "name": "Bloodborne",
        "description": "بازی تاریک و چالش‌برانگیز سولز‌لایک در شهر یارنام",
        "category": "action",
        "platforms": "PS4",
        "version": "standard",
        "price": 1500000,
    ...
    },
    {
        ...
        "description": "ماجراجویی ابرقهرمانی در سیاتل با قدرت‌های خارق‌العاده",
        "category": "action",
        "platforms": "PS4",
        "version": "standard",
        "price": 1200000,
    ...
    {
        "name": "Days Gone",
        "description": "ماجراجویی بقا در دنیای پساآخرالزمانی با زامبی‌های فراوان",
        "category": "action",
    ...
    },
    {
        ...
        "description": "ادامه داستان تأثیرگذار الی و جول",
        "category": "action",
        "platforms": "PS5, PS4",
        "version": "standard",
        "price": 2500000,
    ...
    },
    {
        ...
        "description": "بازی اکشن وولورین با داستان تاریک و خشن",
        "category": "action",
        "platforms": "PS5",
        "version": "standard",
        "price": 3500000,
    ...
    {
        "name": "Astro Bot",
        "description": "بازی پلتفرمر شاد و خلاقانه برای تمام سنین",
        "category": "kids",
        "platforms": "PS5",
        "version": "standard",
        "price": 2200000,
    ...
    },
    {
        ...
        "description": "بازسازی بازی ترسناک کلاسیک با گرافیک مدرن",
        "category": "horror",
        "platforms": "PS5, PC",
        "version": "standard",
        "price": 2800000,
...
async def seed():
    ...
    async with async_session() as session:
        ...
        for game_data in GAMES:
            if game_data["name"] in existing_names:
                print(f"Skipping (exists): {game_data['name']}")
                continue
            game = Game(**game_data)
            session.add(game)
        ...
        print(f"\nDone! {added} new games added. Total in database: {count + added}.")
